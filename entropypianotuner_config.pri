...
!defined(EPT_INSTALL_BIN_DIR):EPT_INSTALL_BIN_DIR=bin
!defined(EPT_INSTALL_DATA_DIR):EPT_INSTALL_DATA_DIR=shared
!defined(EPT_INSTALL_LIB_DIR):EPT_INSTALL_LIB_DIR=lib
