...
INSTALLER_PACKAGE_APP_DATA_DIR=$INSTALLER_DIR/packages/org.entropytuner.app/data
INSTALLER_PACKAGE_DEPS_DATA_DIR=$INSTALLER_DIR/packages/org.entropytuner.deps/data
...
cp EntropyTuner $INSTALLER_PACKAGE_APP_DATA_DIR/$BINARY_FILE_NAME
...
binarycreator -v -n -c config/linux_config_$POSTFIX.xml -p packages $RUN_FILE
