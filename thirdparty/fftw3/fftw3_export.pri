...
contains(FFTW_LIB_MODE_CONFIG, staticlib) {
    gcc:FFTW_EXTERN_LIBS += -Xlinker -start-group -lfftw3 -ldftscalar -ldftscalarcodelets -ldft -lrdftscalar -lrdftscalarr2cf -lrdftscalarr2r -lrdftscalarr2cb -lrdft -lreodft -lkernel -Xlinker -end-group
